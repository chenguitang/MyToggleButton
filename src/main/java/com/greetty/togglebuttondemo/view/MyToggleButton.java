package com.greetty.togglebuttondemo.view;
...
import com.greetty.togglebuttondemo.R;

/**
 * FileName: MyTogglebutton
 * Author: Greetty
 * Time: 2018/10/22 20:57
 * Desc: 自定义控件 : 开关
 */
public class MyToggleButton extends CompoundButton {
    ...
    private void initAttrs(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.MyToggleButton);
        color_on = a.getColor(R.styleable.MyToggleButton_onColor, Color.GREEN);
        color_off = a.getColor(R.styleable.MyToggleButton_offColor, Color.LTGRAY);
        padding = a.getDimension(R.styleable.MyToggleButton_padding, 1);
        a.recycle();
    }
